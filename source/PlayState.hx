...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['You are trash!', 0.2], //From 0% to 19%
		['Very Shit', 0.4], //From 20% to 39%
		['Too Bad', 0.5], //From 40% to 49%
		['Noob', 0.6], //From 50% to 59%
		['Improve', 0.69], //From 60% to 68%
		['Good But Not Enough', 0.7], //69%
		['Very Good', 0.8], //From 70% to 79%
		['Excellent', 0.9], //From 80% to 89%
		['Insane!', 1], //From 90% to 99%
		['I love you!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	{
		scoreTxt.text = 'Punctuation: ' + songScore
		+ ' | Combo Breaks: ' + songMisses
		+ ' | Precision: ' + ratingName
